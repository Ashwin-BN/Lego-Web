...
### Database
- **MongoDB Atlas**: A NoSQL database for storing and managing data, hosted on MongoDB Atlas.
...
## 🚀 Key Features
- **CRUD Operations**: 
  - **Create**: Add new LEGO sets. ✏️
  - **Read**: Display all LEGO sets with links to details about each set. 📖
...
- **User Authentication**: 
  ...
  - **Login/Logout**: Manage user authentication; login is required for accessing and managing protected routes. 🔒
...
- **Error Handling**: 
  ...
  - **500 (Internal Server Error)**: Shows an error page for unexpected server issues, with detailed logs for debugging. ⚠️

---

## 🌐 Deployment
The application is published and hosted on [**Vercel**](https://vercel.com/). 

**Note**: While using MongoDB Atlas, ensure that the necessary IP addresses are whitelisted in your Atlas cluster settings to avoid connection issues during deployment. 🛡️
...
Make sure to replace `your_mongodb_connection_string` with your actual MongoDB connection string. 🗝️
